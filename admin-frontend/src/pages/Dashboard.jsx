                  ...
                  >
                    ...
                    <td style={{ padding: '13px 14px' }}>
                      <div style={{ display: 'flex', gap: 6 }}>
                        <button title="View" onClick={() => { setEditApp(app); setStatusUpdate(app.status); }} style={{ width: 32, height: 32, borderRadius: 8, background: 'rgba(52,152,219,.1)', color: '#3498db', display: 'flex', alignItems: 'center', justifyContent: 'center', border: 'none', cursor: 'pointer', transition: 'all .2s' }}
        ...
        <div className="dashboard-bottom-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>
          ...
          <div className="card animate-fadeInUp" style={{ padding: 22, animationDelay: '.2s' }}>
            <div className="section-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
              ...
              <Link to="/jobs" className="btn-primary" style={{ fontSize: '0.78rem', padding: '8px 14px', gap: 4 }}>
            ...
            <Link to="/jobs" style={{ display: 'flex', alignItems: 'center', gap: 4, color: '#f5a623', fontWeight: 600, fontSize: '0.8rem', marginTop: 14, justifyContent: 'center' }}>
